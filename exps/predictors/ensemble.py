...
from exps.predictors.mlp import MLPPredictor
...
from exps.predictors.seminas import SemiNASPredictor
...
# from exps.predictors.transformer import TransformerPredictorV2
from exps.predictors.trees import XGBoost
    ...
    def get_ensemble(self):
        ...
        trainable_predictors = {
            ...
            "seminas": SemiNASPredictor(
                ss_type=self.ss_type, semi=True, encoding_type="seminas", dataset=self.dataset, bench_api=self.bench_api
            ),
            ...
            # ),
            "xgb": XGBoost(
                ss_type=self.ss_type, zc=False, encoding_type="adjacency_one_hot", bench_api=self.bench_api
            ),
            ...
            # "transformer": TransformerPredictorV2(ss_type=self.ss_type, encoding_type="gcn", dataset=self.dataset, bench_api=self.bench_api),
        }
